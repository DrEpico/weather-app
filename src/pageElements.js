import { getCurrentWeather, getForecast } from './apiHandler';
...
export function addInfoPane(parent) {
    ...
    let infoIds = ['wind', 'humidity', 'precipitation', 'pressure', 'feelsLike', 'uv', 'astro1', 'astro2', 'astro3'];
    infoIds.forEach(id => {
